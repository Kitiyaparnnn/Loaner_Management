...
class AppColors {
  static const Color COLOR_PRIMARY = Color.fromRGBO(51, 119, 255, 1.0);
  static const Color COLOR_SECONDARY = Color.fromRGBO(55, 222, 225, 1.0);
  static const Color COLOR_BLACK = Color.fromRGBO(34, 43, 72, 1.0);
  static const Color COLOR_LIGHT = Color.fromRGBO(119, 136, 167, 1.0);
  ...
  static const Color COLOR_GREEN_LIGHT = Color.fromRGBO(20, 221, 172, 1.0);
